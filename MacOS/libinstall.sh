...
# additional modules, for a list, go to the web page
# https://formulae.brew.sh and insert the search string
# "pothosware". In the long list produced, search for the same
# string using the "search" facility of your internet browser.
#
...
#
# Some SoapySDR modules cannot be compiled using the latest
...
#
# pothosware is considered "untrusted" in latest versions of
# Homebrew. So the following statements may fail unless you
# "manually" declare trust for pothosware. This script will
# *not* do this for you. If the commands below fail, piHPSDR can
# still be built, but the SoapySDR modules for the respective
# radios may be missing.
################################################################
...
# Additional radio support packages retained from the newer
